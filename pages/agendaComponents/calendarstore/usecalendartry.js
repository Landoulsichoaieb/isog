...
import { boxCalendarStore } from '../pages/agendaComponents/calendarstore/boxCalendarStore';
import { lieuCalendarStore } from '../pages/agendaComponents/calendarstore/lieuCalendarStore';
import { moniteurCalendarStore } from '../pages/agendaComponents/calendarstore/moniteurCalendarStore';
import { promotionCalendarStore } from '../pages/agendaComponents/calendarstore/promotionCalendarStore';
import { tuteurCalendarStore } from '../pages/agendaComponents/calendarstore/tuteurCalendarStore';
import { typeCalendarStore } from '../pages/agendaComponents/calendarstore/typeCalendarStore';
...
// 👉 Store
const storetuteur = tuteurCalendarStore()
const storebox = boxCalendarStore()
const storelieu = lieuCalendarStore()
const storemoniteur = moniteurCalendarStore()
const storepromotion = promotionCalendarStore()
const storetype = typeCalendarStore()
